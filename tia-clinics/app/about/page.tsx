          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                Our Muthaiga clinic is designed to provide a luxurious yet
                clinical environment where you can feel comfortable and
                confident throughout your aesthetic journey.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Latest technology including HydraFacial machines, premium
                      injection systems, and medical-grade skincare devices
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Hospital-grade sterilization protocols and clean room
                      standards for all procedures
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Comfortable treatment rooms, relaxation areas, and premium
                      client amenities
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Easily accessible location in Muthaiga with ample parking
                      and security
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="h-48 rounded-lg overflow-hidden shadow-lg">
                    <div
                      ...
                      style={{
                        backgroundImage: "url(/images/Facility.webp)",
                      }}
                    />
                  </div>
                  <div className="h-32 rounded-lg overflow-hidden shadow-lg">
                    <div
                      className="w-full h-full bg-cover bg-center bg-no-repeat"
                      style={{
                        backgroundImage: "url(/images/recept.webp)",
                      }}
                    />
                  </div>
                </div>
                <div className="space-y-4 mt-8">
                  <div className="h-32 rounded-lg overflow-hidden shadow-lg">
                    <div
                      className="w-full h-full bg-cover bg-center bg-no-repeat"
                      style={{
                        backgroundImage: "url(/images/Facility1.webp)",
                      }}
                    />
                  </div>
                  <div className="h-48 rounded-lg overflow-hidden shadow-lg">
                    <div
                      className="w-full h-full bg-cover bg-center bg-no-repeat"
                      style={{
                        backgroundImage: "url(/images/Tia.webp)",
                      }}
                    />
                  </div>
                </div>
