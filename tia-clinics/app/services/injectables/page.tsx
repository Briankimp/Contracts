...
const treatments = [
  ...
  },
  {
    ...
    description:
      "Comprehensive facial balancing for optimal aesthetic proportions",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in-up">
              ...
              <p className="text-xl text-muted-foreground mb-8 text-pretty leading-relaxed">
                Achieve natural-looking facial rejuvenation with our expert
                injectable treatments. Our skilled medical team uses premium
                products to smooth wrinkles, restore volume, and enhance your
                natural beauty.
              </p>
            ...
            <div className="relative animate-fade-in">
              <div className="relative h-96 lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url(https://unsplash.com/photos/_zmiZwgg7Iw/download?force=true)",
                  }}
                />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Choose from our comprehensive range of injectable treatments, each
              tailored to address specific concerns and aesthetic goals.
            </p>
          </div>
      ...
      <section className="py-24 bg-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From consultation to aftercare, we ensure a comfortable and
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground text-sm">
                Customized plan with detailed explanation of procedures
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-muted-foreground text-sm">
                Expert injection technique with premium products
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-muted-foreground text-sm">
                Comprehensive aftercare and progress monitoring
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Prevent formation of deeper wrinkles over time
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Mild swelling, bruising, or redness may occur
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Certain conditions may affect treatment suitability
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-24 bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Schedule your complimentary consultation to discuss your aesthetic
