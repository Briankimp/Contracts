          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div variants={itemVariants}>
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Founded in 2019, TIA Clinics has grown to become Nairobi's premier
                destination for aesthetic medicine. Our journey began with a simple
                vision: to provide world-class aesthetic treatments in a warm,
                welcoming environment that celebrates African beauty.
              </p>
              
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Under the expert leadership of Dr. Arshni Malde, we've built a
                reputation for excellence, combining international training with
                deep understanding of diverse skin types and aesthetic goals.
                Every treatment is personalized, every result is natural, and
                every client leaves feeling more confident than when they arrived.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              The principles that guide everything we do at TIA Clinics
            </p>
          </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6 leading-tight">
              Professional
              <span className="gradient-text block">Certifications</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {certifications.map((certification, index) => (
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300, damping: 20 }}
              >
                <Card className="border-0 shadow-lg h-full bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-6 flex items-center space-x-4">
                    <motion.div
                      className="w-12 h-12 bg-gradient-to-br from-primary to-primary-dark rounded-full flex items-center justify-center shadow-lg flex-shrink-0"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <motion.div variants={itemVariants}>
            ...
            <p className="text-xl mb-8 opacity-90 leading-relaxed">
              Experience the TIA Clinics difference. Book your complimentary
              consultation today and discover how we can help you achieve your
              aesthetic goals with confidence and care.
            </p>
